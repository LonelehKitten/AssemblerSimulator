...
const Item = ({ label, onChange, isSave, onClick, indicator, value, selected }, ref) => {
    ...
    return (
        <button className={"MuiButtonBase-root MuiTab-root MuiTab-textColorInherit" + (selected ? " Mui-selected" : "")} ref={ref} onClick={handleClick} role="tab" aria-selected={selected} tabIndex={selected ? 0 : -1}>
