#ifndef LINKER_PROTO_H
#define LINKER_PROTO_H
...
class LinkerProto {
    protected:
        ...
        virtual bool generateBytecode(Assembler * , bool &error) = 0;

        //construtor
        LinkerProto(std::vector<Assembler *> *file, int programCounter, SymbolTable * globalSymbols);
    ...
    public:
        virtual bool resolveDependencies(std::vector<LinkerProto::PendingResolution *> &dependenciesMap, bool strict, bool * symbolWasResolvedHolder = nullptr);
